...
// create range of colors from darkened passed color (instead of black) through our passed color to white
function getRange(hexColor) {
	const end = '#fff';
	return [ chroma(hexColor).darken(1.4).hex(), hexColor, end ];
}
// returns numberOfColors (10) colors which range from white to darkened version of original color
